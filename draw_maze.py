...
# def draw_cell(canvas, c, r, color="#CCCCCC"):
#     """Draw a single cell on canvas

#     Args:
#         canvas (tklinter.Canvas): Background
#         c (int): Column number, starts from 0.
#         r (int): Row number, starts from 0.
#         color (str, optional): color. Defaults to "#CCCCCC"(light grey).
#     """
...
#     Args:
#         canvas (tkinter.Canvas): Background
#     """
#     for ri in range(R):
#         for ci in range(C):
#             draw_cell(canvas, ci, ri)
 
# def draw_obstacles(canvas, obs_pos, color="#000000"):
#     """Draw obstacles, default color is black 
...
#     """
#     for current_position in obs_pos:
#         draw_cell(canvas, current_position[0], current_position[1], color=color)
